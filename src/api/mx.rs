...
use trust_dns_proto::rr::{rdata::MX, Name, RData, Record};
...
pub async fn add_record(
    ...
    let record = Record::from_rdata(domain.clone(), data.ttl, RData::MX(data.data));
    ...
    state
        ...
        .await
        .map_err(|err| {
            error!("Failed to insert MX record: {}", err);
